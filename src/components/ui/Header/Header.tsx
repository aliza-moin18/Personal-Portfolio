...
//             <Link href="/" className="text-white hover:text-purple-600">Home</Link>
//             <Link href="/about" className="text-white hover:text-purple-600">About Me</Link>
//             <Link href="/services" className="text-white hover:text-purple-600"> Services </Link>
//             <Link href="/work" className="text-white hover:text-purple-600"> Work </Link>
//             <Link href="/contact" className="text-white hover:text-purple-600">Contact</Link>
//           </nav>
//           <Link href="/contact">
